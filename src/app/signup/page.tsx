...
export default function SignupPage() {
  ...
  return (
    <main className="max-w-sm mx-auto px-6 py-16 font-sans">
      <h1 className="font-serif text-3xl font-medium mb-8 text-fg">Sign up</h1>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <p className="text-xs text-fg-subtle mt-1.5">
            3–32 characters. Lowercase letters, numbers, hyphen, underscore.
          </p>
        </div>
        <div>
          <label
          ...
          <input
            ...
            className={inputClass}
          />
          <p className="text-xs text-fg-subtle mt-1.5">At least 6 characters.</p>
        </div>
        {error && (
